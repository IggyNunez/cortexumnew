...
type AuthContextType = {
  ...
  isLoading: boolean;
  error: Error | null;
  loginMutation: UseMutationResult<{ success: boolean; data: SelectUser }, Error, LoginData>;
  logoutMutation: UseMutationResult<{ success: boolean; message: string }, Error, void>;
  registerMutation: UseMutationResult<{ success: boolean; data: SelectUser }, Error, InsertUser>;
};
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const {
    ...
    error,
    isLoading,
  } = useQuery<{ success: boolean; data: SelectUser }>({
    queryKey: ["/api/user"],
